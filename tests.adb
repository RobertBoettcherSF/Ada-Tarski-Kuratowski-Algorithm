...
begin
   ...
   Assert (Result.Class = Delta and Result.Level = 0 and Result.V_Order = First_Order, "Failed Empty Arithmetical");
   Put_Line ("     PASS");
   ...
   Assert (Result.Class = Sigma and Result.Level = 2, "Failed E0->A0");
   Put_Line ("     PASS");
   ...
   Assert (Result.Class = Pi and Result.Level = 3, "Failed A0->E0->A0");
   Put_Line ("     PASS");
   ...
   Assert (Result.Class = Sigma and Result.Level = 1, "Failed Block Collapse E0,E0");
   Put_Line ("     PASS");
   ...
   Assert (Result.Class = Pi and Result.Level = 3, "Failed Complex Collapse");
   Put_Line ("     PASS");
   ...
   Assert (Result.Class = Sigma and Result.Level = 1 and Result.V_Order = Second_Order, "Failed E1");
   Put_Line ("     PASS");
   ...
   Assert (Result.Class = Sigma and Result.Level = 1, "Failed First_Order Absorption");
   Put_Line ("     PASS");
   ...
   Assert (Result.Class = Pi and Result.Level = 3, "Failed A1->E1->A1");
   Put_Line ("     PASS");
   ...
   Assert (Result.Class = Pi and Result.Level = 2, "Failed Mixed Alternation");
   Put_Line ("     PASS");
   ...
   Assert (Result.Class = Delta and Result.Level = 1 and Result.V_Order = Second_Order, "Failed Type 0 in Type 1 bounds");
   Put_Line ("     PASS");
